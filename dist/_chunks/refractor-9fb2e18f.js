...
var index = require('./index-966c28c1.js');
...
function mapChild(child, i, depth) {
  ...
  return isReactRefractorMarkerDataWithComponent(child.data) ? React.createElement(child.data.component, __spreadProps$1(__spreadValues$1(__spreadValues$1({
    key
  }, child.properties), child.data.markerProperties), {
    className
  }), children) : React.createElement(child.tagName, {
    key,
    className
  }, children);
}
...
function Refractor(props) {
  ...
  if (props.inline && (codeProps.style = {
    ...
    const code2 = /* @__PURE__ */jsxRuntime.jsx("code", __spreadProps(__spreadValues({}, codeProps), {
      children: props.value
    }));
    return props.inline ? code2 : /* @__PURE__ */jsxRuntime.jsx("pre", {
      className: preClass,
      children: code2
    });
  }
  ...
  const value = ast.children.length === 0 ? props.value : ast.children.map(mapWithDepth(0)),
    code = /* @__PURE__ */jsxRuntime.jsx("code", __spreadProps(__spreadValues({}, codeProps), {
      children: value
    }));
  return props.inline ? code : /* @__PURE__ */jsxRuntime.jsx("pre", {
    className: preClass,
    children: code
  });
}
...
function LazyRefractor(props) {
  ...
  const registered = t0;
  let t1;
  $[2] !== language || $[3] !== registered || $[4] !== value ? (t1 = !(language && registered) && /* @__PURE__ */jsxRuntime.jsx("code", {
    children: value
  }), $[2] = language, $[3] = registered, $[4] = value, $[5] = t1) : t1 = $[5];
  let t2;
  $[6] !== language || $[7] !== registered || $[8] !== value ? (t2 = language && registered && /* @__PURE__ */jsxRuntime.jsx(Refractor, {
    inline: !0,
    language,
    value: String(value)
  }), $[6] = language, $[7] = registered, $[8] = value, $[9] = t2) : t2 = $[9];
  let t3;
  return $[10] !== t1 || $[11] !== t2 ? (t3 = /* @__PURE__ */jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [t1, t2]
  }), $[10] = t1, $[11] = t2, $[12] = t3) : t3 = $[12], t3;
}
LazyRefractor.displayName = "LazyRefractor";
exports.default = LazyRefractor;
//# sourceMappingURL=refractor-9fb2e18f.js.map
